...
# report it; 30 spaces
GlobalPerformanceTime=`grep "STKPERF: Total Time" dgNonConformalFluids.log  | awk '{print $4}'`
if [ $PASS_STATUS -ne 1 ]; then
    echo -e "..dgNonConformalFluids........ FAILED":" " $GlobalPerformanceTime " s " " max diff: " $GlobalMaxSolutionDiff
else
    echo -e "..dgNonConformalFluids........ PASSED":" " $GlobalPerformanceTime " s " 
fi
