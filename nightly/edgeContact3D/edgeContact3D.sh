...
# report it; 30 spaces
GlobalPerformanceTime=`grep "STKPERF: Total Time" edgeContact3D.log  | awk '{print $4}'`
if [ $PASS_STATUS -ne 1 ]; then
    echo -e "..edgeContact3D............... FAILED":" " $GlobalPerformanceTime " s" " max diff: " $GlobalMaxSolutionDiff
else
