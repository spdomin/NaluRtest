...
# report it; 30 spaces
GlobalPerformanceTime=`grep "STKPERF: Total Time" dgNonConformal.log  | awk '{print $4}'`
if [ $PASS_STATUS -ne 1 ]; then
    echo -e "..dgNonConformal.............. FAILED":" " $GlobalPerformanceTime " s " " max diff: " $GlobalMaxSolutionDiff
else
