...
# report it; 30 spaces
GlobalPerformanceTime=`grep "STKPERF: Total Time" periodic3dElemNp1.log  | awk '{print $4}'`
if [ $PASS_STATUS -ne 1 ]; then
    echo -e "..periodic3dElemNp1........... FAILED":" " $GlobalPerformanceTime " s" " max diff: " $GlobalMaxSolutionDiff
else
    echo -e "..periodic3dElemNp1........... PASSED":" " $GlobalPerformanceTime " s"
fi
