...
# report it; 30 spaces
GlobalPerformanceTime=`grep "STKPERF: Total Time" periodic3dElemNp8.log  | awk '{print $4}'`
if [ $PASS_STATUS -ne 1 ]; then
    echo -e "..periodic3dElemNp8........... FAILED":" " $GlobalPerformanceTime " s" " max diff: " $GlobalMaxSolutionDiff
else
    echo -e "..periodic3dElemNp8........... PASSED":" " $GlobalPerformanceTime " s"
fi
