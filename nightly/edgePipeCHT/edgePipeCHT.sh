...
# report it; 30 spaces
GlobalPerformanceTime=`grep "STKPERF: Total Time" edgePipeCHT.log  | awk '{print $4}'`
if [ $PASS_STATUS -ne 1 ]; then
    echo -e "..edgePipeCHT................. FAILED":" " $GlobalPerformanceTime " s" " max diff: " $GlobalMaxSolutionDiff
else
