...
# report it; 30 spaces
GlobalPerformanceTime=`grep "STKPERF: Total Time" dgNonConformal3dFluidsHexTet.log  | awk '{print $4}'`
if [ $PASS_STATUS -ne 1 ]; then
    echo -e "..dgNonConformal3dFluidsHexTet.FAILED":" " $GlobalPerformanceTime " s " " max diff: " $GlobalMaxSolutionDiff
else
    echo -e "..dgNonConformal3dFluidsHexTet.PASSED":" " $GlobalPerformanceTime " s " 
fi
